...
public class TC_07_VerifyTravelQuoteSummary extends BaseTest {
    ...
    public void verifyTravelQuoteSummary() {
        ...
        Assert.assertTrue(
                travelHomePage.isRedirectedToSelectTravellerCount(),
        ...
        boolean seniorTravellerPresent =
                false;
